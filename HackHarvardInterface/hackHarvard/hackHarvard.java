...
public class hackHarvard extends Application {
    private ArrayList<workTopic> workTopics = new ArrayList<>();

    @Override
    public void start(Stage primaryStage) {
        workTopics = new ArrayList<workTopic>();
    ...
    private void showWorkTopicDialog() {
        ...
        do {
            ...
            dialog.setResultConverter(buttonType -> {
                if (buttonType.getText().equals("Done")) {
                    return null;
                } else if (buttonType.getText().equals("Next")) {
                    try {
